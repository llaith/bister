...
import com.siwasoftware.platform.core.dto.broker.WatchSubmission;
...
public interface WatchService {
    ...
    Integer lockWatchGroup(String sessionUid, String group);

    List<Integer> lockWatchGroups(String sessionUid, String namespace, String owner, String record);

    List<Integer> lockWatchGroups(String sessionUid, String namespace, String owner, String record, String type);

    void releaseWatchLock(String lockUid);

    Watch createWatch(String lockUid, WatchSubmission init); // returns a handle for tracking, not the task because that would bypass the locking.

    List<Watch> getWatchGroup(String lockUid); // this one get's all the parent/child links

    List<Watch> getWatchGroups(Collection<String> lockUids);

    void deleteWatch(String lockUid, Watch watch);

    void deleteWatchGroup(String lockUid);
